...
describe('Space Age', () => {
  ...
  test("invalid planet", () => {
    expect(() => age('ziemia', 123123123)).toThrow("There's no such planet as ziemia!");
  });

  test("invalid seconds argument", () => {
    expect(() => age('earth', 'sekundy')).toThrow("Second argument should be a number!");
  });
});
