...
describe('Robot', () => {
  ...
  // test("A can be randomized", () => {
  //   let letter = "";
  //   while(letter !== "A") {
  //     letter = robot.getRandomLetter();
  //   }

  //   expect(letter).toEqual("A");
  // });
  
  // test("Z can be randomized", () => {
  //   let letter = "";
  //   while(letter !== "Z") {
  //     letter = robot.getRandomLetter();
  //   }
  ...
  // test("000 can be randomized", () => {
  //   let number = "";
  //   while(number !== "000") {
  //     number = robot.getRandomNumber();
  //   }

  //   expect(number).toEqual("000");
  // });
  
  // test("999 can be randomized", () => {
  //   let number = "";
  //   while(number !== "999") {
  //     number = robot.getRandomNumber();
  //   }
